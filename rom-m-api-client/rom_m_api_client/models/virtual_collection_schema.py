...
T = TypeVar("T", bound="VirtualCollectionSchema")


@_attrs_define
class VirtualCollectionSchema:
    """
    Attributes:
        name (str):
        description (str):
        ...
        is_virtual (bool | Unset):  Default: True.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        virtual_collection_schema.additional_properties = d
        return virtual_collection_schema
