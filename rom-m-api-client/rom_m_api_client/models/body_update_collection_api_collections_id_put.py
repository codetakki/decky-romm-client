...
T = TypeVar("T", bound="BodyUpdateCollectionApiCollectionsIdPut")


@_attrs_define
class BodyUpdateCollectionApiCollectionsIdPut:
    """
    Attributes:
        artwork (File | None | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_update_collection_api_collections_id_put = cls(
            artwork=artwork,
        )

        body_update_collection_api_collections_id_put.additional_properties = d
        return body_update_collection_api_collections_id_put
