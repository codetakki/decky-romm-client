...
T = TypeVar("T", bound="BodyAddCollectionApiCollectionsPost")


@_attrs_define
class BodyAddCollectionApiCollectionsPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_add_collection_api_collections_post = cls(
            artwork=artwork,
        )

        body_add_collection_api_collections_post.additional_properties = d
        return body_add_collection_api_collections_post
