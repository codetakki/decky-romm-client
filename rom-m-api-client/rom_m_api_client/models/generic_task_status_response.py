...
if TYPE_CHECKING:
    from ..models.generic_task_meta import GenericTaskMeta


T = TypeVar("T", bound="GenericTaskStatusResponse")


@_attrs_define
class GenericTaskStatusResponse:
    """
    Attributes:
        task_name (str):
        task_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_type = cast(Literal["generic"], d.pop("task_type"))
        if task_type != "generic":
            raise ValueError(f"task_type must match const 'generic', got '{task_type}'")

        meta = GenericTaskMeta.from_dict(d.pop("meta"))

        generic_task_status_response = cls(
            task_name=task_name,
            task_id=task_id,
            status=status,
            created_at=created_at,
        ...
        generic_task_status_response.additional_properties = d
        return generic_task_status_response
