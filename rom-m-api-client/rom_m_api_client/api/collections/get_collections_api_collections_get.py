...
) -> HTTPValidationError | list[CollectionSchema] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CollectionSchema.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | list[CollectionSchema]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        updated_after (datetime.datetime | None | Unset): Filter collections updated after this
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | list[CollectionSchema]
    """
